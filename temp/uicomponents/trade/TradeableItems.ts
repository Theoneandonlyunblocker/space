...
export class TradeableItems_COMPONENT_TODO extends React.Component<PropTypes, StateType>
{
...
const Factory: React.Factory<PropTypes> = React.createFactory(TradeableItems_COMPONENT_TODO);
