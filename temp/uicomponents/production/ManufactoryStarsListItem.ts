...
class ManufactoryStarsListItem extends React.Component<PropTypes, StateType>
{
...
const Factory: React.Factory<PropTypes> = React.createFactory(ManufactoryStarsListItem);
