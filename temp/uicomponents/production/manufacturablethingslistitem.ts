...
class ManufacturableThingsListItem extends React.Component<PropTypes, StateType>
{
...
const Factory: React.Factory<PropTypes> = React.createFactory(ManufacturableThingsListItem);
