...
export class UnitExperience_COMPONENT_TODO extends React.Component<PropTypes, StateType>
{
...
const Factory: React.Factory<PropTypes> = React.createFactory(UnitExperience_COMPONENT_TODO);
