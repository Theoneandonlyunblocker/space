...
export class FlagPickerComponent extends React.Component<PropTypes, StateType>
{
  ...
  handleSelectEmblem(emblemTemplate: SubEmblemTemplate)
  {
    ...
    React.findDOMNode<HTMLInputElement>(this.ref_TODO_imageUploader).value = null;
  ...
  handleUpload()
  {
    ...
    var files = React.findDOMNode<HTMLInputElement>(this.ref_TODO_imageUploader).files;
