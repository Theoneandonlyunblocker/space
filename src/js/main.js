    ...
    (function (Templates) {
        (function (MapGen) {
            function spiralGalaxyGeneration(options) {
                ...
                // make voronoi
                var voronoi = Rance.MapGen2.makeVoronoi(allStars, options.defaultOptions.width, options.defaultOptions.height);
                ...
                voronoi = Rance.MapGen2.makeVoronoi(allStars, options.defaultOptions.width, options.defaultOptions.height);
    ...
    var MapGen = (function () {
            ...
            for (var i = 0; i < this.startLocations.length; i++) {
                ...
                for (var j = 0; j < nonFillerPoints.length; j++) {
                    ...
                    if (!isFinite(star.mapGenData.distanceFromNearestStartLocation)) {
                        ...
                        star.mapGenData.distanceFromNearestStartLocation = Math.min(distance, star.mapGenData.distanceFromNearestStartLocation);
                    }
                }
            }
        };
        ...
        MapGen.prototype.triangulate = function () {
            if (!this.points || this.points.length < 3)
                throw new Error();
            this.triangles = Rance.MapGen2.triangulate(this.points);
        ...
        MapGen.prototype.relaxPointsOnce = function (dampeningFactor) {
            ...
            for (var i = 0; i < this.voronoiDiagram.cells.length; i++) {
                ...
                var centroid = Rance.MapGen2.getCentroid(vertices);
        ...
        MapGen.prototype.getFillerPoints = function () {
            if (!this.points)
                return [];
