...
import {Range} from "core/math/Range";
import {MapGenOptionValues} from "core/templateinterfaces/MapGenOptionValues";
import {MapGenOptions as MapGenOptionsObj} from "core/templateinterfaces/MapGenOptions";
...
export class MapGenOptionsComponent extends React.Component<PropTypes, StateType>
{
  ...
  render()
  {
    ...
    const optionGroupsInfo =
    {
      defaultOptions:
      {
        title: localize("defaultOptions").toString(),
        isCollapsedInitially: false,
      },
      basicOptions:
      {
        title: localize("basicOptions").toString(),
        isCollapsedInitially: false,
      },
      advancedOptions:
      {
        title: localize("advancedOptions").toString(),
