export const errors =
{
  ...
  openConsoleInstructions: "Ctrl+Shift+J (Cmd+Shift+J) or F12 on most desktop browsers.",
  ...
  errorWithGameRecovery: "An additional error occurred trying to render the UI for save game recovery.",
};
